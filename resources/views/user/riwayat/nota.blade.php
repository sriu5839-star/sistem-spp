...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nota-container { max-width: 800px; margin: 0 auto; background: white; border: 1px solid #ddd; padding: 30px; }
        ...
        .detail-section h2 { color: #2563eb; font-size: 18px; margin-bottom: 15px; border-bottom: 1px solid #e5e7eb; padding-bottom: 10px; }
        .detail-table { width: 100%; border-collapse: collapse; }
        .detail-table th, .detail-table td { padding: 12px; text-align: left; border-bottom: 1px solid #e5e7eb; }
        .detail-table th { background: #f3f4f6; color: #374151; font-weight: 600; }
        ...
        .total-row.grand-total { font-size: 20px; font-weight: bold; color: #2563eb; border-top: 2px solid #2563eb; padding-top: 10px; margin-top: 15px; }
    ...
    <div class="nota-container">
        ...
        <div class="info-section">
            ...
            <div class="info-box">
                ...
                <p><strong>Tanggal:</strong> {{ optional($pembayaran->tgl_bayar)->format('d/m/Y') }}</p>
